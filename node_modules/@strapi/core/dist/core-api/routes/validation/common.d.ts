...
export declare abstract class AbstractCoreRouteValidator<T extends UID.Schema> extends AbstractRouteValidator {
     ...
     */
    protected get _schema(): T extends UID.ContentType ? import("@strapi/types/dist/schema/index.js").ContentType<T> : T extends `${string}.${string}` ? import("@strapi/types/dist/schema/index.js").Component<T> : never;
    /**
