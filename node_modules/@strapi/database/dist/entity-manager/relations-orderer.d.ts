 ...
 * @return {*}
 */
declare const relationsOrderer: <TRelation extends Record<string, ID | number | null>>(initArr: TRelation[], idColumn: keyof TRelation, orderColumn: keyof TRelation, strict?: boolean) => {
    disconnect(relations: Link | Link[]): /*elided*/ any;
    connect(relations: Link | Link[]): /*elided*/ any;
    get(): OrderedLink[];
    /**
