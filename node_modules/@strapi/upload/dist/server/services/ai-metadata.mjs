...
import { AI_METADATA_SUPPORTED_IMAGE_TYPES, isAIMetadataSupportedMime, AI_METADATA_CHUNK_SIZE } from '../shared/constants.mjs';
...
const isSupportedImage = (file)=>isAIMetadataSupportedMime(file.mime);
