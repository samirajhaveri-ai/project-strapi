...
declare const _default: () => {
    ...
    controllers: {
        'admin-file': {
            ...
            unstable_generateAIMetadata(ctx: import("koa").Context): Promise<any>;
    ...
    services: {
        ...
        file: {
            ...
            fetchUrlToInputFile: (url: string, tmpWorkingDirectory: string, sizeLimit?: number, onProgress?: (progress: import("./services/file").UrlFetchProgress) => void) => Promise<import("./services/file").FetchUrlResult>;
        };
        ...
        aiMetadata: ({ strapi }: {
            ...
            generateForFiles(fileIds: Array<number | string>, user: {
                id: string | number;
            }): Promise<import("./services/ai-metadata").AIMetadataFileResult[]>;
