...
var MuxPlayer__default = /*#__PURE__*/_interopDefault(MuxPlayer);
...
const AssetPreview = /*#__PURE__*/ React__namespace.forwardRef(({ mime, url, name, ...props }, ref)=>{
    ...
    if (assetType === enums.ASSET_TYPES.Image) {
    ...
    if (assetType === enums.ASSET_TYPES.Video) {
        return /*#__PURE__*/ jsxRuntime.jsx(MuxPlayer__default.default, {
            src: url,
            accentColor: theme.colors.primary500
        });
    }
    if (assetType === enums.ASSET_TYPES.Audio) {
