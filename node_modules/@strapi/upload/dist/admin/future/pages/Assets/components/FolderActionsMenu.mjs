...
import { More, Link, Pencil, ArrowRight, Trash } from '@strapi/icons';
...
import { FolderFormDialog } from './FolderFormDialog.mjs';
 ...
 */ const FolderActionsMenu = ({ folder, dragData })=>{
    ...
    return /*#__PURE__*/ jsxs(Fragment, {
        children: [
            ...
            isRenameOpen && /*#__PURE__*/ jsx(FolderFormDialog, {
                open: true,
                mode: "rename",
                folderId: folder.id,
...
export { FolderActionsMenu };
//# sourceMappingURL=FolderActionsMenu.mjs.map
