...
import { Typography, Tooltip, Box, Button, IconButton, Flex } from '@strapi/design-system';
import { Sparkle, ArrowRight, Trash, Cross } from '@strapi/icons';
import { useIntl } from 'react-intl';
import { styled } from 'styled-components';
import { AI_METADATA_MAX_FILES, isAIMetadataSupportedMime } from '../../../../shared/constants.mjs';
...
import '../../../services/assets.mjs';
import { buildDragSetFromSelection } from '../../../utils/buildDragSetFromSelection.mjs';
import { emptyItemLocations } from '../../../utils/itemLocations.mjs';
...
import { useGenerateAiMetadataMutation } from '../../../services/api.mjs';
...
`;
const BulkActionsBar = ({ assets = [], locations = emptyItemLocations })=>{
    ...
    const moveItems = useMemo(()=>buildDragSetFromSelection(selectedIds, selectedFolderIds, locations, currentFolderId), [
        selectedIds,
        selectedFolderIds,
        locations,
        currentFolderId
...
//# sourceMappingURL=BulkActionsBar.mjs.map
