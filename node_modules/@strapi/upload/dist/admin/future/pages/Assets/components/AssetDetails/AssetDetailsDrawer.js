...
const AssetImageActions = ({ onCrop, mime })=>{
    const { formatMessage } = reactIntl.useIntl();
...
const AssetDetails = ({ asset, closeDetails })=>{
    ...
    const handleReplace = React__namespace.useCallback(async (file)=>{
    ...
    const handleDelete = React__namespace.useCallback(async ()=>{
                    ...
                    children: ({ modified, isSubmitting, values, resetForm })=>{
                        ...
                        return /*#__PURE__*/ jsxRuntime.jsxs(jsxRuntime.Fragment, {
                            children: [
                                ...
                                busyMessage ? /*#__PURE__*/ jsxRuntime.jsx(BusyOverlay.BusyOverlay, {
...
exports.getBusyMessage = getBusyMessage;
