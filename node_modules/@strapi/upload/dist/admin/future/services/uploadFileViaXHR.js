 ...
 */ const sendUploadViaXHR = (url, token, formData, signal, onProgress)=>{
...
const uploadFileViaXHR = async (url, token, formData, signal, onProgress)=>{
    try {
        ...
        try {
            const refreshedToken = await strapiAdmin.attemptTokenRefresh();
