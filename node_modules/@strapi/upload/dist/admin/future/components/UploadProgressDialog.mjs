...
import { closeUploadProgress, selectAggregateProgress, selectMetadataProgress, selectIsGeneratingMetadata, selectMetadataOutcome, cancelUpload, toggleMinimize } from '../store/uploadProgress.mjs';
 ...
 * -----------------------------------------------------------------------------------------------*/ const HeaderStatusMessage = ({ title, subtitle, metadataSubtitle })=>{
    return /*#__PURE__*/ jsxs(Flex, {
        ...
        children: [
            ...
            metadataSubtitle && /*#__PURE__*/ jsx(Typography, {
                variant: "pi",
                textColor: "neutral600",
 ...
 */ const IndeterminateBar = ()=>{
    return /*#__PURE__*/ jsx(ProgressTrack, {
        ...
        "aria-valuemin": 0,
        "aria-valuemax": 100,
        children: /*#__PURE__*/ jsx(IndeterminateIndicator, {})
    });
};
    ...
    if (isCurrentFile) {
        ...
        return /*#__PURE__*/ jsxs(FileRow, {
            ...
            children: [
                ...
                hasReportedProgress ? /*#__PURE__*/ jsx(DeterminateBar, {
    ...
    if (isCompleted) {
        ...
        return /*#__PURE__*/ jsxs(FileRow, {
            ...
            children: [
                ...
                file.metadataStatus === 'generating' && /*#__PURE__*/ jsx(IndeterminateBar, {})
            ]
        });
    }
    return null;
