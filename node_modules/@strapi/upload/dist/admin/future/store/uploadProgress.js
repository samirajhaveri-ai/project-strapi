 ...
 */ const selectMetadataProgress = toolkit.createSelector((state)=>state.uploadProgress.files, (files)=>{
 ...
 */ const selectIsGeneratingMetadata = toolkit.createSelector((state)=>state.uploadProgress.files, (files)=>{
 ...
 */ const selectMetadataOutcome = toolkit.createSelector((state)=>state.uploadProgress.files, (files)=>{
    const started = files.filter((f)=>f.metadataStatus !== undefined);
    if (started.length === 0) return null;
...
exports.selectIsGeneratingMetadata = selectIsGeneratingMetadata;
exports.selectMetadataOutcome = selectMetadataOutcome;
exports.selectMetadataProgress = selectMetadataProgress;
exports.setFileComplete = setFileComplete;
exports.setFileError = setFileError;
exports.setFileMetadataGenerating = setFileMetadataGenerating;
exports.setFileMetadataResult = setFileMetadataResult;
