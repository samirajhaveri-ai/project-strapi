 ...
 */ const RelationsField = /*#__PURE__*/ React__namespace.forwardRef(({ disabled, label, ...props }, ref)=>{
     ...
     */ const relations$2 = React__namespace.useMemo(()=>{
        ...
        /**
       * Tidy up our data.
       */ const withoutConnected = removeConnected(ctx)([
            ...serverData
        ]);
...
const RelationModalWithContext = ({ relation, name, placeholder, hasNextPage, isLoadingSearchRelations, isLoadingPermissions, handleChange, mainField, setSearchParams, fieldValue, data, ...props })=>{
    ...
    const componentUID = ComponentContext.useComponent('RelationsField', (state)=>state.uid);
    const getParentFormValues = strapiAdmin.useForm('RelationModalWrapper', (state)=>state.getValues);
    const getParentFormValuesWithCurrentRelation = ()=>{
        return objects.setIn(getParentFormValues(), name, fieldValue);
    };
    const handleLoadMore = ()=>{
