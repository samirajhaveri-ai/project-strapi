...
import { useRBAC, Page, useTracking, useNotification, useClipboard, useAPIErrorHandler, useIsMobile, useScopedPersistentState, useQueryParams, useStrapiApp, SearchInput, Layouts, tours, BackButton, Table, Pagination, useTable } from '@strapi/admin/strapi-admin';
