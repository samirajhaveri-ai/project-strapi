...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-N4LJTXDS.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: isBetaMediaLibrary ? () => {
        ...
        return import("./App-D3VNLOYX.js").then((mod) => ({
          default: mod.Upload
        }));
      },
      position: 4
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-7EBONAF4.js").then((mod) => ({
          default: mod.App
        })),
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-MD35QMRY.js");
...
//# sourceMappingURL=chunk-WME22RMY.js.map
