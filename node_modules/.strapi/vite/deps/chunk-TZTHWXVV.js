import {
  ...
  StageColumn,
  getDisplayName
} from "./chunk-V4S2PJPJ.js";
import {
  buildValidParams as buildValidParams2
} from "./chunk-PAY54OVR.js";
import {
  getStageColorByHex
} from "./chunk-F66HFPRW.js";
import {
  LimitsModal,
  useReviewWorkflows
} from "./chunk-3MN6WDPC.js";
import {
...
} from "./chunk-7OONFG2L.js";
import {
  index
} from "./chunk-LQ2Z2SAE.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-BPWDGFC2.js";
import {
  useConfig
} from "./chunk-RHXUZMP7.js";
import {
  useTracking
} from "./chunk-3JBY3ZP2.js";
import {
  Drawer,
  abortUpload,
  cancelUpload,
...
import {
  ...
  reducer,
  reducer2
} from "./chunk-NZVNKXSA.js";
import {
  pluginId
} from "./chunk-5QJFIL32.js";
import {
  useDocumentActions
} from "./chunk-AXLZZ46F.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-6JUVHU5S.js";
import {
  renderAdmin,
  require_baseUniq,
  useDebounce
} from "./chunk-V3M2IRQ6.js";
import {
  useAIAvailability
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-C443FYEC.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
...
var admin = {
  ...
  register(app) {
    app.addSettingsLink({
      ...
      id: "settings",
      to: "email",
      Component: () => import("./Settings-N5MM5KS6.js").then((mod) => ({
  ...
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: isBetaMediaLibrary ? () => {
        return import("./App-BEKS5OYO.js").then((mod) => ({
          default: mod.BetaMediaLibrary
        }));
      } : () => {
        return import("./App-S457QYX5.js").then((mod) => ({
          default: mod.Upload
        }));
      },
      position: 4
    ...
    app.addSettingsLink("global", {
      ...
      Component() {
        return import("./SettingsPage-MNS3HKLV.js").then((mod) => ({
          default: mod.ProtectedSettingsPage
        }));
      },
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-IHLOFF7H.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-NLQZPLMY.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        Component() {
          return import("./ReleasesSettingsPage-BTGRCVGH.js").then((mod) => ({
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-GSBTXMVY.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        Component() {
          return import("./PurchaseContentReleases-4TOBW6LT.js").then((mod) => ({
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        Component() {
          return import("./router-YVCF45QG.js").then((mod) => ({
            default: mod.Router
          }));
        }
      });
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-LXTSESRJ.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        Component() {
          return import("./purchase-review-workflows-2AV77DRS.js").then((mod) => ({
...
//# sourceMappingURL=chunk-TZTHWXVV.js.map
